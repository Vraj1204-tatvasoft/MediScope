...
namespace MediScope.Data.Migrations
{
    ...
    [Migration("20260811091734_AddUniqueConstraintToBroadcastRecipients")]
    partial class AddUniqueConstraintToBroadcastRecipients
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MediScope.Common.Models.Entities.Broadcast", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<int?>("RemainingBatches")
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("MediScope.Common.Models.Entities.BroadcastRecipient", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("MediScope.Common.Models.Entities.QuestionOption", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("MediScope.Common.Models.Entities.Questionnaire", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("MediScope.Common.Models.Entities.QuestionnaireAssignment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.ToTable("questionnaire_assignments", (string)null);
                });

            modelBuilder.Entity("MediScope.Common.Models.Entities.QuestionnaireQuestion", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("MediScope.Common.Models.Entities.QuestionnaireSubmission", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.ToTable("questionnaire_submissions", (string)null);
                });
            ...
            modelBuilder.Entity("MediScope.Common.Models.Entities.SubmissionResponse", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.PrimitiveCollection<string[]>("ResponseValues")
                        .HasColumnType("text[]")
            ...
            modelBuilder.Entity("MediScope.Common.Models.Entities.BroadcastRecipient", b =>
                {
                    b.HasOne("MediScope.Common.Models.Entities.Broadcast", "Broadcast")
                        .WithMany("Recipients")
            ...
            modelBuilder.Entity("MediScope.Common.Models.Entities.QuestionOption", b =>
                {
                    b.HasOne("MediScope.Common.Models.Entities.QuestionnaireQuestion", "Question")
                        .WithMany("Options")
            ...
            modelBuilder.Entity("MediScope.Common.Models.Entities.QuestionnaireAssignment", b =>
                {
                    ...
                    b.HasOne("MediScope.Common.Models.Entities.Questionnaire", "Questionnaire")
                        .WithMany()
            ...
            modelBuilder.Entity("MediScope.Common.Models.Entities.QuestionnaireSubmission", b =>
                {
                    b.HasOne("MediScope.Common.Models.Entities.QuestionnaireAssignment", "Assignment")
            ...
            modelBuilder.Entity("MediScope.Common.Models.Entities.SubmissionResponse", b =>
                {
                    ...
                    b.HasOne("MediScope.Common.Models.Entities.QuestionnaireSubmission", "Submission")
                        .WithMany("Responses")
